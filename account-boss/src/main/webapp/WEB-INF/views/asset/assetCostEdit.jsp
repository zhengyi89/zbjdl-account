	...
	<div id="content_2" class="content_wrapper">
		<div class="content_main">
			<div class="panel panel-default">
				<div class="panel-heading">费用摊销</div>
				<div class="panel-body">
					<form method="post" id="godownForma" name="godownForma"
						...
						<input type="hidden" value="EXPENSE" id="costType" name="costType"> 
						<div class="assets-add-header"><span>基本信息</span><span class="assets-add-voucher">无</span><span class="assets-add-voucher">费用摊销凭证:</span></div>
						
						<div class="form-group">
							<label for="inputPassword3" class="col-lg-2 control-label">费用编码:</label>
							<div class="col-lg-3">
								<input type="text" class="form-control" value="${dto.assetCode}" id="assetCode" name="assetCode" />
							</div>
							<label for="inputPassword3" class="col-lg-2 control-label">费用名称:</label>
							<div class="col-lg-3">
						...
						<div class="form-group">
							...
							<div class="col-lg-3">
								<select class="form-control" id="assetClassCode" name="assetClassCode" onclick="selectAssetClass()">
						...
						<div class="form-group">
							<label for="inputPassword3" class="col-lg-2 control-label">待摊费用科目:</label>
							<div class="col-lg-3">
						   ...
						   <label for="inputPassword3" class="col-lg-2 control-label">费用分摊科目:</label>
							<div class="col-lg-3">
						...
						<div class="assets-add-header"><span>费用摊销资料</span></div>
						<div class="form-group">
						   <label for="inputPassword3" class="col-lg-2 control-label">待摊费用金额:</label>
						   <div class="col-lg-3">
						...
						<div class="form-group">
						   <label for="inputPassword3" class="col-lg-2 control-label">月分摊额:</label>
						    <div class="col-lg-3">
	...
	<script type="text/javascript">
		...
		function selectAssetClass(){
			...
			$.ajax({
				...
				data:'deprecitionType=EXPENSE&assetClassCode='+v_class,
				async: false,
		...
		function computeCost(){
			...
			if(v_asset_worth!='' && v_use_age!=''){
				// 月分摊额＝待摊费用金额／预计使用期限
				var v_amount = v_asset_worth/v_use_age;
