				...
				<div class="panel-body">
					<div class="panel-table">
						...
						<q:table queryService="queryService" queryKey="queryAssistAccountList" formId="godownForma"
				            ...
				            <q:column title="编码" value="${assist_code}" width="20%" />
				            <q:column title="名称" value="${assist_name}" width="20%" />
				            <q:column title="类别" value="${_textResource.getSysText('ACCOUNT_ASSIST_TYPE', assist_type)}" width="20%" />
				            <q:column title="企业税号" value="${tax_num}" width="20%" />
