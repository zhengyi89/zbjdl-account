		...
		<div class="content_main">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="cmxform form-horizontal" action="${pageContext.request.contextPath}/voucher/templateIndex" 
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="panel-table">
						<a href="${pageContext.request.contextPath}/voucher/edit/index?templateFlag=1">
						...
						<q:table queryService="queryService" queryKey="queryVoucherTemplateList" formId="godownForma"
				            ...
				            <q:column title="操作" escapeHtml="false" width="20%">
							    ...
							    &nbsp;
							    <a class="pink" onclick="window.location.href='${ctx}/voucher/edit/index?id=${id}&templateFlag=1'">编辑</a>
							    &nbsp;
							</q:column>
						</q:table>
					</div>
